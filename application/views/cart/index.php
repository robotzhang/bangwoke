...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name=alipayment onSubmit="return CheckForm();" action="<?php echo site_url() ?>/cart/todo" method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    <dt>标题：</dt>
                    <dd>
                        <span class="red-star">*</span>
                        <input size=30 name=cart[subject] />
                        <span>如：7月5日定货款。</span>
                    </dd>
                    <dt>付款金额：</dt>
                    <dd>
                        <span class="red-star">*</span>
                        <input maxLength=10 size=30 name=cart[price] onfocus="if(Number(this.value)==0){this.value='';}" value="00.00"/>
                        <span>如：112.21</span>
                    </dd>
                    <dt>备注：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <textarea style="margin-left:3px;" name=cart[body] rows=2 cols=40 wrap="physical"></textarea><br/>
